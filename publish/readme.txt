...
созвонов и работы с экраном. Приложение добавляет поверх рабочего стола лазерный
указатель, spotlight, лупу, инструменты рисования, экранные доски и быстрые
скриншоты.
...
режим аннотаций или экранной доски, overlay начинает принимать ввод мыши и
клавиатуры.
...
области, чтобы показывать реальный экран под ними.
...
- Modes
  Laser, Shot, Draw, Spot, Zoom.

- Board
  Screen, Black, White.

- Color
  Быстрый выбор цвета аннотаций.

- Size
  Уменьшение / увеличение толщины линии.

- Tools
  Pen, Mark, Arrow, Line, Rect, Oval, Text, Move.
...
- цвета аннотаций;
- пользовательский пятый цвет аннотаций в HEX;
- толщина линии;
...
- Неподписанный exe может вызывать предупреждение Windows SmartScreen. Это
  нормально для новых неподписанных приложений, но для широкой публикации лучше
...
7. Нажмите Ctrl+Alt+G, чтобы создать screen board, нарисуйте поверх снимка и
