...
Основные режимы:
  ...
  Alt+A             - быстрая аннотация по удержанию
  Alt+Z             - удержание лазера в режиме Hold
  Alt+X             - удержание подсветки курсора в режиме Hold
...
Лазер в режиме Hold:
  ...
  Alt+Z            - удержание лазера по умолчанию

Alt+Z - удержание лазера по умолчанию. В настройках его можно заменить.
...
- Hold key / mouse button
  ...
  По умолчанию используется Alt+Z.
