...
public partial class SettingsWindow : Window
{
    ...
    [
        ...
        new(PushToAnnotateBox, "Hold to annotate", s => s.PushToAnnotate, (s, v) => s.PushToAnnotate = v, true),
        new(ToggleLaserActivationBox, "Toggle laser mode", s => s.ToggleLaserActivation, (s, v) => s.ToggleLaserActivation = v, true),
        new(ToggleCursorHighlightBox, "Toggle highlight mode", s => s.ToggleCursorHighlight, (s, v) => s.ToggleCursorHighlight = v, true),
        new(ToggleClickPulseBox, "Toggle click pulse", s => s.ToggleClickPulse, (s, v) => s.ToggleClickPulse = v, true),
        ...
        new(ClearRegionSpotlightsBox, "Clear spotlights", s => s.ClearRegionSpotlights, (s, v) => s.ClearRegionSpotlights = v, true),
        new(ToggleFadingAnnotationsBox, "Toggle fading", s => s.ToggleFadingAnnotations, (s, v) => s.ToggleFadingAnnotations = v, true),
        new(ToggleTimerBox, "New timer", s => s.ToggleTimer, (s, v) => s.ToggleTimer = v, true),
        new(ToggleToolbarBox, "Toggle toolbar", s => s.ToggleToolbar, (s, v) => s.ToggleToolbar = v, true),
        new(TakeScreenshotBox, "Current monitor screenshot", s => s.TakeScreenshot, (s, v) => s.TakeScreenshot = v, true),
        new(TakeRegionScreenshotBox, "Region screenshot", s => s.TakeRegionScreenshot, (s, v) => s.TakeRegionScreenshot = v, true),
        new(ToggleScreenBoardBox, "Toggle screen board", s => s.ToggleScreenBoard, (s, v) => s.ToggleScreenBoard = v, true),
        new(ToggleBlackScreenBox, "Toggle black board", s => s.ToggleBlackScreen, (s, v) => s.ToggleBlackScreen = v, true),
        new(ToggleWhiteScreenBox, "Toggle white board", s => s.ToggleWhiteScreen, (s, v) => s.ToggleWhiteScreen = v, true),
        ...
        new(ExitAnnotateBox, "Exit annotation mode", s => s.ExitAnnotate, (s, v) => s.ExitAnnotate = v, false),
    ];
